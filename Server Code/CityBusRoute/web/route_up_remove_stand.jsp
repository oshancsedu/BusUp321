					...
					<li><a href="route_up_update_coordinate.jsp">Update Coordinate</a></li>
                            ...
                            <div class="9u important(collapse)">
                                ...
                                <form action="RouteUpController" method="post">
                                    ...
                                    <input type="text" placeholder="Enter Stopage" name="etStopage"><br><br>
                                    <input type="submit" value="Delete Stopage" name="btSubmit" class="button-big">
                                </form>
                            </div>
			</div>
                    </div>
