					...
					<li><a href="route_up_update_coordinate.jsp">Update Coordinate</a></li>
                            ...
                            <div class="9u important(collapse)">
                                ...
                                <form action="RouteUpController" method="post">
                                    ...
                                    <input type="text" placeholder="Enter Previous Stopage" name="etPrevStopage"><br><br>
                                    <input type="text" placeholder="Enter New Stopage" name="etNewStopage"><br><br>
                                    <input type="submit" value="Update Stopage" name="btSubmit" class="button-big">
                                </form>
                            </div>
			</div>
                    </div>
